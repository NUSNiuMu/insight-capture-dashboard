...
from insight_capture.common.config import (
    build_dashboard_config,
    load_setup,
)
from insight_capture.common.paths import PROJECT_ROOT, runtime_config_path
from insight_capture.postprocess.gripper.tracking import GripperTrackingMixin
from insight_capture.postprocess.gripper.overlay import HandOverlayMixin
from insight_capture.media.jpeg import HwJpegCodec
from insight_capture.common import performance as perf_tracker
...
from insight_capture.web import WebDashboardServer, bagplay_topic

from insight_capture.runtime import (
    CameraFrame,
    CameraSpec,
    CaptureCheckManager,
    ImagePipeline,
...
def default_runtime_config_path() -> Path:
    """Prefer the canonical runtime config while accepting existing live installs."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--web-root", default=str(PROJECT_ROOT / "web_dashboard" / "dist"))
