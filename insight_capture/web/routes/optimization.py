...
from insight_capture.common.config import IMAGE_STREAMS
from insight_capture.web.support import _read_tum_points
...
class OptimizationRoutes:
    ...
    async def _handle_optimization_start(self, request: web.Request) -> web.Response:
        ...
        from insight_capture.common.config import camera_base, image_topic as mk_image_topic
