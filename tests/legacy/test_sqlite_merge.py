...
from insight_capture.runtime.recording.recovery import RecordingRecovery  # noqa: E402
from insight_capture.legacy.sqlite_bag import merge_sqlite_parts  # noqa: E402
...
class SqliteMergeTest(unittest.TestCase):
    ...
    def test_recording_merge_falls_back_to_ros2_converter(self) -> None:
        ...
        with patch(
            "insight_capture.runtime.recording.recovery.merge_sqlite_parts",
