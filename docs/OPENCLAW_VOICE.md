...
固定“开始录制”和“停止录制”会立即分别播报“正在开始录制”和“正在结束录制”，无需等待
...
“检查相机”，系统先播报“开始检测”，再把两路 Insight3 和 Insight9 当前全局 Pose 分别
与保存值比较并播报通过、重新放置或重新校准。Insight3 使用严格阈值，Insight9 使用较宽
阈值；两路 Insight3 必须已完成本轮全局定位，但不要求检测瞬间再次命中地图。
